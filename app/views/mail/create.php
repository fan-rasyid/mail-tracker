    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Create Incoming Mail</h2>
                <p class="section-lead">
                    Please fill in the details below to add a new incoming mail record.
                </p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Incoming Mail Form</h4>
                            </div>

                            <form action="<?= BASEURL ?>MailsController/store" method="POST"
